    ...
    <nav class="-mx-3 space-y-6 ">
      <div class="space-y-3 ">
        ...
        >
          ...
          <span class="mx-2 text-sm font-medium">My Feed</span>
        </a>
      </div>
      <div class="space-y-3 ">
        <label class="px-3 text-xs font-semibold uppercase text-gray-900">
        ...
        >
          ...
          <span class="mx-2 text-sm font-medium">My Blogs</span>
        </a>
        <a
          class="flex transform items-center rounded-lg px-3 py-2 text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700"
          href="#"
      ...
      <div class="space-y-3 ">
        ...
        >
          ...
          <span class="mx-2 text-sm font-medium">Profile Settings</span>
        </a>
      </div>
    </nav>
  </div>
